...
CROPS = {
    ...
    'amaranth': {'model': 'crop', 'texture': 'crop', 'stages': 8},
    ...
    'black_eyed_peas': {'model': 'tfc:large_cross', 'texture': 'cross', 'stages': 7},
    ...
    'rutabaga': {'model': 'cross', 'texture': 'cross', 'stages': 7},
    'turnip': {'model': 'cross', 'texture': 'cross', 'stages': 7},
    'mustard': {'model': 'crop', 'texture': 'crop', 'stages': 7},
    'sweet_potato': {'model': 'cross', 'texture': 'cross', 'stages': 7},
    'sugar_beet': {'model': 'cross', 'texture': 'cross', 'stages': 7},
    'purple_grape': {'model': 'crop', 'texture': 'crop', 'stages': 8},
    'green_grape': {'model': 'crop', 'texture': 'crop', 'stages': 8},
    'agave': {'model': 'tfc:large_cross', 'texture': 'cross', 'stages': 6},
    'coca': {'model': 'cross', 'texture': 'cross', 'stages': 6},
    ...
    'hops': {'model': 'tfc:large_cross', 'texture': 'crop', 'stages': 8},
    'indigo': {'model': 'tfc:crop_tall', 'texture': 'crop', 'stages': 5},
    'madder': {'model': 'tfc:crop_tall', 'texture': 'crop', 'stages': 5},
    'opium_poppy': {'model': 'cross', 'texture': 'cross', 'stages': 6},
    'rape': {'model': 'crop', 'texture': 'crop', 'stages': 6},
    'weld': {'model': 'tfc:crop_tall', 'texture': 'crop', 'stages': 5},
    'woad': {'model': 'crop', 'texture': 'crop', 'stages': 6},
    'tobacco': {'model': 'tfc:large_cross', 'texture': 'cross', 'stages': 7},
    'coffea': {'model': 'tfc:large_cross', 'texture': 'cross', 'stages': 8}
}
