...
public class BlockRockVariantFallableTFCE extends BlockRockVariantTFCE implements IFallingBlock
{
    public BlockRockVariantFallableTFCE(RockTFCE.Type type, RockTFCE rock)
    {
        super(type, rock);
    }
