...
import net.dries007.tfc.world.classic.chunkdata.*;
...
public final class ChunkDataTFCE
{
    public static final int FISH_POP_MAX = 60;

    private static final ChunkDataTFCE EMPTY = new ChunkDataTFCE();
    ...
    @Nonnull
    public static ChunkDataTFCE get(World world, BlockPos pos)
    {
        return get(world.getChunk(pos));
    }

    @Nonnull
    public static ChunkDataTFCE get(Chunk chunk)
    {
        ChunkDataTFCE data = chunk.getCapability(ChunkDataProviderTFCE.CHUNK_DATA_CAPABILITY, null);
        return data == null ? EMPTY : data;
    }

    public static RockTFCE getRock1(World world, BlockPos pos)
    {
        return get(world, pos).getRockLayer1(pos.getX() & 15, pos.getZ() & 15);
    }

    public static RockTFCE getRock2(World world, BlockPos pos)
    {
        return get(world, pos).getRockLayer2(pos.getX() & 15, pos.getZ() & 15);
    }

    public static RockTFCE getRock3(World world, BlockPos pos)
    {
    ...
    public static RockTFCE getRockHeight(World world, BlockPos pos)
    {
    ...
    public RockTFCE getRock1(BlockPos pos)
    {
        return getRock1(pos.getX() & 15, pos.getY() & 15);
    }

    public RockTFCE getRock1(int x, int z)
    {
        return getRockLayer1(x, z);
    }

    public RockTFCE getRock2(BlockPos pos)
    {
        return getRock2(pos.getX() & 15, pos.getY() & 15);
    }

    public RockTFCE getRock2(int x, int z)
    {
        return getRockLayer2(x, z);
    }

    public RockTFCE getRock3(BlockPos pos)
    {
        return getRock3(pos.getX() & 15, pos.getY() & 15);
    }

    public RockTFCE getRock3(int x, int z)
    {
    ...
    public RockTFCE getRockHeight(BlockPos pos)
    {
        return getRockHeight(pos.getX(), pos.getY(), pos.getZ());
    }

    public RockTFCE getRockHeight(int x, int y, int z)
    {
    ...
    public RockTFCE getRockLayer1(int x, int z)
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS_TFCE).getValue(rockLayer1[z << 4 | x]);
    }

    public RockTFCE getRockLayer2(int x, int z)
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS_TFCE).getValue(rockLayer2[z << 4 | x]);
    }

    public RockTFCE getRockLayer3(int x, int z)
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS_TFCE).getValue(rockLayer3[z << 4 | x]);
    }
    ...
    public RockTFCE getRockLayerHeight(int x, int y, int z)
    {
    ...
    public static final class ChunkDataStorage implements Capability.IStorage<ChunkDataTFCE>
    {
        ...
        @Nullable
        @Override
        public NBTBase writeNBT(Capability<ChunkDataTFCE> capability, ChunkDataTFCE instance, EnumFacing side)
        {
        ...
        @Override
        public void readNBT(Capability<ChunkDataTFCE> capability, ChunkDataTFCE instance, EnumFacing side, NBTBase nbt)
        {
