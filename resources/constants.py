...
WOODS: Dict[str, Wood] = {
    ...
    'pink_cherry_blossom': Wood(795, 1250),
    'white_cherry_blossom': Wood(795, 1250),
    'cocobolo': Wood(773, 1000),
    'cypress': Wood(783, 1100),
    'ebony': Wood(795, 1000),
    'argyle_eucalyptus': Wood(705, 1000),
    'rainbow_eucalyptus': Wood(705, 1000),
    'snow_gum_eucalyptus': Wood(705, 1000),
    ...
    'pink_ipe': Wood(785, 1200),
    'purple_ipe': Wood(785, 1200),
    'white_ipe': Wood(785, 1200),
    'yellow_ipe': Wood(785, 1200),
    'iroko': Wood(785, 1200),
    'ironwood': Wood(694, 1970),
    'purple_jacaranda': Wood(795, 1250),
    'white_jacaranda': Wood(795, 1250),
    'yellow_jacaranda': Wood(795, 1250),
    'joshua': Wood(696, 1250),
    ...
    'red_mangrove': Wood(783, 1100),
    'white_mangrove': Wood(783, 1100),
...
TREE_SAPLING_DROP_CHANCES = {
    ...
    'white_cedar': 0.0204,
    'willow': 0.0092,
    'african_padauk': 0.0083,
    'alder': 0.0071,
    'angelim': 0.0083,
    'argyle_eucalyptus': 0.0083,
    'bald_cypress': 0.0074,
    'beech': 0.0071,
    'black_walnut': 0.0083,
    'black_willow': 0.0071,
    ...
    'mulberry': 0.0074,
    'nordmann_fir': 0.0083,
    'norway_spruce': 0.0083,
    'pink_cherry_blossom': 0.0067,
    'pink_ipe': 0.0083,
    'pink_ivory': 0.0078,
    'poplar': 0.0083,
    'purple_ipe': 0.0083,
    'purple_jacaranda': 0.0067,
    'purpleheart': 0.0083,
    'rainbow_eucalyptus': 0.0083,
    'red_cedar': 0.0083,
    'red_cypress': 0.0074,
    'red_elm': 0.0074,
    'redwood': 0.0083,
    'rowan': 0.0074,
    'rubber_fig': 0.0074,
    'snow_gum_eucalyptus': 0.0083,
    'sweetgum': 0.0074,
    'syzygium': 0.0078,
    'teak': 0.0083,
    'walnut': 0.0083,
    'wenge': 0.0083,
    'white_cherry_blossom': 0.0067,
    'white_elm': 0.0074,
    'white_ipe': 0.0083,
    'white_jacaranda': 0.0067,
    'whitebeam': 0.0070,
    'yellow_ipe': 0.0083,
    'yellow_jacaranda': 0.0067,
