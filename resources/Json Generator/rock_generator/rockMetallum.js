...
let metalTypes = {
  ...
  'cobalt': 'cobalt',
  'compressed_iron': 'compressed_iron',
  'enderium': 'enderium',
  'ferroboron': 'ferroboron',
  'florentine_bronze': 'florentine_bronze',
  'invar': 'invar',
  'lumium': 'lumium',
  'mithril': 'mithril',
  ...
  'titanium': 'titanium',
  'tungsten': 'tungsten',
  'tungsten_steel': 'tungsten_steel',
  'uranium': 'uranium'
}

let metalTypesNoIngot = {
...
function generateJSON(rockType)
{
  ...
  for(let metalType in metalTypes)
  {
      ...
      for (let clayType in clayTypes)
      {
        if (moldType != "ingot")
        {
          let recipeCasting = {
            "type": "tfc:casting",
            "mold": {
              "item": `tfcflorae:ceramic/${clayType}/fired/mold/${moldType}`
            },
            "fluid": {
              "ingredient": `tfc_metallum:metal/${metalType}`,
              "amount": 100
            },
            "result": {
              "item": `tfc_metallum:metal/${moldType}/${metalType}`
            },
            "break_chance": 1
          }
          fs.writeFileSync(`./metallum/data/recipes/casting/${clayType}/${moldType}/${metalType}.json`, JSON.stringify(recipeCasting, null, 2))
        }
        else
        {
          let recipeCasting = {
  ...
  for (let metalNoIngot in metalTypesNoIngot)
  {
    for(let moldType in moldTypes)
    {
      if (moldType == "ingot")
      {
        for (let clayType in clayTypes)
        {
          let recipeCasting = {
            ...
            "fluid": {
              "ingredient": `tfc_metallum:metal/${metalNoIngot}`,
              "amount": 100
            },
            "result": {
              "item": `tfc_metallum:metal/${moldType}/${metalNoIngot}`
            },
            "break_chance": 0.1
          }
          fs.writeFileSync(`./metallum/data/recipes/casting/${clayType}/${moldType}/${metalNoIngot}.json`, JSON.stringify(recipeCasting, null, 2))
        }
      }
    }
  }
  ...
  for(let rockTFCF in ROCK_TYPES_TFCF)
  {
      ...
      if (metallumOre != "certus_quartz")
      {
        for(let oreGrade in oreGrades)
        {
          let blockstateOres = {
            "variants": {
              "": {
                "model": `mfcompat:block/ore/${oreGrade}_${metallumOre}/${rockTFCF}`
              }
            }
          }
          let modelBlockOres = {
            ...
            "textures": {
              "all": `tfcflorae:block/rock/raw/${rockTFCF}`,
              "particle": `tfcflorae:block/rock/raw/${rockTFCF}`,
              "overlay": `tfc_metallum:block/ore/${oreGrade}_${metallumOre}`
            }
          }
          let modelItemOres = {
            "parent": `mfcompat:block/ore/${oreGrade}_${metallumOre}/${rockTFCF}`
          }
          let loottableOres = {
            "type": "minecraft:block",
            "pools": [
              {
                ...
                "entries": [
                  {
                    "type": "minecraft:item",
                    "name": `tfc_metallum:ore/${oreGrade}_${metallumOre}`
                  }
                ],
                "conditions": [
                  {
          ...
          fs.writeFileSync(`./metallum_florae/assets/blockstates/ore/${oreGrade}_${metallumOre}/${rockTFCF}.json`, JSON.stringify(blockstateOres, null, 2))
          fs.writeFileSync(`./metallum_florae/assets/models/block/ore/${oreGrade}_${metallumOre}/${rockTFCF}.json`, JSON.stringify(modelBlockOres, null, 2))
          fs.writeFileSync(`./metallum_florae/assets/models/item/ore/${oreGrade}_${metallumOre}/${rockTFCF}.json`, JSON.stringify(modelItemOres, null, 2))
          fs.writeFileSync(`./metallum_florae/data/loot_tables/blocks/ore/${oreGrade}_${metallumOre}/${rockTFCF}.json`, JSON.stringify(loottableOres, null, 2))
        }
      }
      else if (metallumOre == "certus_quartz")
      {
        let blockstateOresCertusQuartz = {
          "variants": {
            "": {
              "model": `mfcompat:block/ore/${metallumOre}/${rockTFCF}`
            }
          }
        }
        let modelBlockOresCertusQuartz = {
          "parent": "tfc:block/ore",
          "textures": {
            "all": `tfcflorae:block/rock/raw/${rockTFCF}`,
            "particle": `tfcflorae:block/rock/raw/${rockTFCF}`,
            "overlay": `tfc_metallum:block/ore/${metallumOre}`
          }
        }
        let modelItemOresCertusQuartz = {
          "parent": `mfcompat:block/ore/${metallumOre}/${rockTFCF}`
        }
        let loottableOresCertusQuartz = {
          "type": "minecraft:block",
          "pools": [
            {
              "name": "loot_pool",
              ...
              "entries": [
                {
                  "type": "minecraft:item",
                  "name": `tfc_metallum:ore/${metallumOre}`
                }
              ],
              "conditions": [
                {
        ...
        fs.writeFileSync(`./metallum_florae/assets/blockstates/ore/${metallumOre}/${rockTFCF}.json`, JSON.stringify(blockstateOresCertusQuartz, null, 2))
        fs.writeFileSync(`./metallum_florae/assets/models/block/ore/${metallumOre}/${rockTFCF}.json`, JSON.stringify(modelBlockOresCertusQuartz, null, 2))
        fs.writeFileSync(`./metallum_florae/assets/models/item/ore/${metallumOre}/${rockTFCF}.json`, JSON.stringify(modelItemOresCertusQuartz, null, 2))
        fs.writeFileSync(`./metallum_florae/data/loot_tables/blocks/ore/${metallumOre}/${rockTFCF}.json`, JSON.stringify(loottableOresCertusQuartz, null, 2))
      }
    }
  }
}
