...
function generateJSON(rockType)
{
  ...
  for (let rockBlockType in rockBlockTypes)
  {
    ...
    let blockstateRockBoulderBlockNew = {
      "multipart":
      [
        {
          "when": {
    ...
    fs.writeFileSync(`./assets/blockstates/rock/rock_pile_new/${rockType}.json`, JSON.stringify(blockstateRockBoulderBlockNew, null, 2))
