...
package tfcflorae.objects.blocks.agriculture;
...
public class BlockFruitTreeTrunkTFCF extends Block
{
  ...
  private static final Map<IFruitTree, BlockFruitTreeTrunkTFCF> MAP = new HashMap<>();
  ...
  public static BlockFruitTreeTrunkTFCF get(IFruitTree tree)
  {
      return MAP.get(tree);
  }
  ...
  public BlockFruitTreeTrunkTFCF(IFruitTree tree)
  {
  ...
  public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess worldIn, BlockPos pos)
  {
      ...
      {
          if (worldIn.getBlockState(pos.offset(face)).getBlock() == BlockFruitTreeBranchTFCF.get(tree))
          {
                  ...
                  if (worldIn.getBlockState(pos.up()).getBlock() != this) //If the above block is a trunk, this one don't need to do anything
                  {
                      if (this.getTrunkHeight(worldIn, pos) < 4)
                      {
                          ...
                          if (missingLeaf != null)
                          {
                              ...
                              {
                                  worldIn.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCF.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCF.HARVESTABLE, false));
                              }
                          }
                          else
                          {
                      ...
                      {
                          //Starting with top
                          if (worldIn.getBlockState(pos.up()).getBlock() != BlockFruitTreeBranchTFCF.get(tree))
                          {
                              BlockPos missingLeaf = getMissingLeaf(worldIn, pos);
                              if (missingLeaf != null)
                              {
                                  ...
                                  if (worldIn.getBlockState(missingLeaf).getMaterial().isReplaceable())
                                  {
                                      worldIn.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCF.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCF.HARVESTABLE, true));
                                  }
                                  return; //Done what we needed to do on this stage
                              }
                              else
                              {
                                  worldIn.setBlockState(pos.up(), BlockFruitTreeBranchTFCF.get(tree).getDefaultState());
                          ...
                          for (EnumFacing branchFacing : shuffledList)
                          {
                              ...
                              if (worldIn.getBlockState(branchPos).getBlock() != BlockFruitTreeBranchTFCF.get(tree))
                              {
                                  if (worldIn.getBlockState(branchPos).getMaterial().isReplaceable())
                                  {
                                      worldIn.setBlockState(branchPos, BlockFruitTreeBranchTFCF.get(tree).getDefaultState());
                                  }
                                  return; //Done what we needed to do on this stage
                              }
  ...
  public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos)
  {
      ...
      if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockFruitTreeTrunkTFCF) && !BlocksTFC.isGrowableSoil(worldIn.getBlockState(pos.down())))
      {
  ...
  public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
  {
      ...
      if (!worldIn.isRemote)
      {
          ...
          Block branch = BlockFruitTreeBranchTFCF.get(tree);
  ...
  {
      return new ItemStack(BlockFruitTreeSaplingTFCF.get(tree));
  }
  ...
  private BlockPos getMissingLeaf(World world, BlockPos branchPos, EnumFacing branchFacing)
  {
      ...
      if (world.getBlockState(branchPos.offset(branchFacing)).getBlock() != BlockFruitTreeLeavesTFCF.get(tree))
      {
      ...
      {
          if (world.getBlockState(pos).getBlock() != BlockFruitTreeLeavesTFCF.get(tree))
          {
              return pos;
          }
      }
  ...
  private BlockPos getMissingLeaf(World world, BlockPos pos)
  {
      ...
      //Above first
      if (world.getBlockState(pos.offset(EnumFacing.UP)).getBlock() != BlockFruitTreeLeavesTFCF.get(tree))
      {
      ...
      {
          if (world.getBlockState(pos.offset(facing)).getBlock() != BlockFruitTreeLeavesTFCF.get(tree))
          {
  ...
  private void levelUpLeaves(World world, BlockPos oldCenter, boolean hasvestable)
  {
      ...
      {
          if (world.getBlockState(oldCenter.offset(facing)).getBlock() == BlockFruitTreeLeavesTFCF.get(tree))
          {
      ...
      do
      {
          ...
          {
              world.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCF.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCF.HARVESTABLE, hasvestable));
          }
          else
          {
