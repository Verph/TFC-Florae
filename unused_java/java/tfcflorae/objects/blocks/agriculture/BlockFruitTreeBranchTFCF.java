...
public class BlockFruitTreeBranchTFCF extends Block
{
  ...
  private static final Map<IFruitTree, BlockFruitTreeBranchTFCF> MAP = new HashMap<>();

  public static BlockFruitTreeBranchTFCF get(IFruitTree tree)
  {
      return MAP.get(tree);
  }
  ...
  public BlockFruitTreeBranchTFCF(IFruitTree tree)
  {
  ...
  public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess worldIn, BlockPos pos)
  {
      ...
      {
          if (worldIn.getBlockState(pos.offset(facing)).getBlock() instanceof BlockFruitTreeLeavesTFCF)
          {
  ...
  public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
  {
      ...
      if (stack.getItem().getToolClasses(stack).contains("axe") || stack.getItem().getToolClasses(stack).contains("saw"))
      {
          ...
          {
              ItemStack dropStack = new ItemStack(BlockFruitTreeSaplingTFCF.get(tree));
  ...
  private EnumFacing getFacing(IBlockAccess worldIn, BlockPos pos)
  {
      for (EnumFacing facing : EnumFacing.VALUES)
      {
          if (worldIn.getBlockState(pos.offset(facing)).getBlock() == BlockFruitTreeTrunkTFCF.get(tree))
          {
