...
public final class TreesTFCE
{
    ...
    public static void onPreRegisterRockCategory(TFCRegistryEvent.RegisterPreBlock<Tree> event)
    {
	    ...
	    r.register(new Tree.Builder(EBONY, 180f, 550f, 20f, 38f, GEN_EBONY).setGrowthTime(8).setBushes().setBushes().setBurnInfo(795f, 1000).build());
        ...
        r.register(new Tree.Builder(FEVER, 10f, 250f, 14f, 50f, GEN_FEVER).setGrowthTime(10).setBushes().setDensity(0.25f, 1f).setBurnInfo(590f, 1000).build());
        ...
        r.register(new Tree.Builder(HAWTHORN, 180f, 430f, -8f, 18f, GEN_HAWTHORN).setGrowthTime(8).setBushes().setDensity(0.25f, 1f).setBurnInfo(683f, 1500).build());
        ...
        */
        ...
        r.register(new Tree.Builder(ALDER, 150f, 450f, -4f, 18f, GEN_ALDER).setGrowthTime(8).setBushes().setDensity(0.25f, 2f).setBurnInfo(601f, 1000).build());
	    r.register(new Tree.Builder(BAMBOO, 200f, 420f, 13f, 35f, GEN_TALL).setDominance(0f).setDecayDist(6).setGrowthTime(3).setDensity(0f, 0f).setBurnInfo(420f, 1000).build());
	    r.register(new Tree.Builder(BAOBAB, 20f, 200f, 21f, 40f, GEN_BAOBAB).setDecayDist(6).setGrowthTime(20).setDensity(0.4f, 0.7f).setBurnInfo(478f, 1000).build());
        r.register(new Tree.Builder(BEECH, 220f, 550f, 2f, 22f, GEN_BEECH).setGrowthTime(8).setBushes().setTannin().setDensity(0.25f, 1f).setBurnInfo(703f, 1750).build());
        ...
        r.register(new Tree.Builder(YEW, 180f, 430f, -8f, 14f, GEN_YEW).setGrowthTime(10).setBushes().setBurnInfo(813f, 2150).build());
    }
}
