...
public final class TreesTFCE
{
    ...
    public static void onPreRegisterRockCategory(TFCRegistryEvent.RegisterPreBlock<Tree> event)
    {
        ...
        r.register(new Tree.Builder(MAHOGANY, 210f, 700f, 18f, 40f, GEN_MAHOGANY).setDominance(10f).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(1.5f, 2f).setBurnInfo(773f, 1000).build());
