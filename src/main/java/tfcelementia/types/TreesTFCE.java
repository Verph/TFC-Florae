...
public final class TreesTFCE
{
    ...
    public static void onPreRegisterRockCategory(TFCRegistryEvent.RegisterPreBlock<Tree> event)
    {
	    ...
	    r.register(new Tree.Builder(CINNAMON, 180f, 550f, 15f, 30f, GEN_CINNAMON).setDominance(0.5f).setGrowthTime(8).setBushes().setDensity(0.25f, 1f).setBurnInfo(795f, 1000).build());
	    ...
	    r.register(new Tree.Builder(EUCALYPTUS, 10f, 300f, 20f, 42f, GEN_EUCALYPTUS).setGrowthTime(8).setBushes().setDensity(0.25f, 2f).setBurnInfo(705f, 1000).build());
        ...
        r.register(new Tree.Builder(FRUITWOOD, 180f, 550f, 10f, 30f, GEN_FRUITWOOD).setDominance(0.5f).setGrowthTime(9).setDensity(0.25f, 2f).setBurnInfo(720f, 1000).build());
        ...
        r.register(new Tree.Builder(LIMBA, 290f, 550f, 18f, 40f, GEN_LIMBA).setGrowthTime(9).setBushes().setDensity(0.25f, 2f).setBurnInfo(710f, 1000).build());
        r.register(new Tree.Builder(MAHOGANY, 210f, 700f, 18f, 40f, GEN_MAHOGANY).setDominance(16f).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(3f, 10f).setBurnInfo(773f, 1000).build());
	    ...
	    r.register(new Tree.Builder(REDWOOD, 200f, 400f, 2f, 18f, GEN_REDWOOD).setDecayDist(6).setGrowthTime(18).setConifer().setBushes().setTannin().setDensity(0.4f, 1.5f).setBurnInfo(618f, 1750).build());
