...
public final class MetalsTFCE
{
    ...
    //Metalloid
    public static final ResourceLocation ULEXITE = new ResourceLocation(MOD_ID, "ulexite");
    ...
    public static final ResourceLocation STAINLESS_STEEL = new ResourceLocation(MOD_ID, "stainless_steel");
    public static final ResourceLocation LOCKALLOY = new ResourceLocation(MOD_ID, "lockalloy");
    public static final ResourceLocation MANGANIN = new ResourceLocation(MOD_ID, "manganin");
    public static final ResourceLocation GALINSTAN = new ResourceLocation(MOD_ID, "galinstan");
    public static final ResourceLocation CROWN_GOLD = new ResourceLocation(MOD_ID, "crown_gold");
    public static final ResourceLocation WHITE_GOLD = new ResourceLocation(MOD_ID, "white_gold");
    public static final ResourceLocation SOLDER = new ResourceLocation(MOD_ID, "solder");
    public static final ResourceLocation MAGNOX = new ResourceLocation(MOD_ID, "magnox");
    public static final ResourceLocation PLATINUM_STERLING = new ResourceLocation(MOD_ID, "platinum_sterling");
    public static final ResourceLocation TITANIUM_GOLD = new ResourceLocation(MOD_ID, "titanium_gold");
