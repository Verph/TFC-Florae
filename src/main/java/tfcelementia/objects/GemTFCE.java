...
public enum GemTFCE
{
    ...
    private static final GemTFCE[] RANDOM_DROP_GEMS = Arrays.stream(values()).filter(x -> x.canDrop).toArray(GemTFCE[]::new);
     ...
     */
    public static GemTFCE getRandomDropGem(Random random)
    {
