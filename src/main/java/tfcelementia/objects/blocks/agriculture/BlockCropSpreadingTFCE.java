...
public abstract class BlockCropSpreadingTFCE extends BlockCropTFCE
{
    private static final int MAX_SPREAD_AGE = 16;

    public static BlockCropSpreadingTFCE create(ICrop crop)
    {
        ...
        return new BlockCropSpreadingTFCE(crop)
        {
            @Override
    ...
    BlockCropSpreadingTFCE(ICrop crop)
    {
        super(crop);
