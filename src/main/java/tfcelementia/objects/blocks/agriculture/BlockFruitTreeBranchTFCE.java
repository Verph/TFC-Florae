...
public class BlockFruitTreeBranchTFCE extends Block
{
    ...
    private static final Map<IFruitTree, BlockFruitTreeBranchTFCE> MAP = new HashMap<>();

    public static BlockFruitTreeBranchTFCE get(IFruitTree tree)
    {
        return MAP.get(tree);
    }
    ...
    public BlockFruitTreeBranchTFCE(IFruitTree tree)
    {
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        {
            if (worldIn.getBlockState(pos.offset(facing)).getBlock() instanceof BlockFruitTreeLeavesTFCE)
            {
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player)
    {
        ...
        if (stack.getItem().getToolClasses(stack).contains("axe") || stack.getItem().getToolClasses(stack).contains("saw"))
        {
            ...
            {
                ItemStack dropStack = new ItemStack(BlockFruitTreeSaplingTFCE.get(tree));
    ...
    private EnumFacing getFacing(IBlockAccess worldIn, BlockPos pos)
    {
        for (EnumFacing facing : EnumFacing.VALUES)
        {
            if (worldIn.getBlockState(pos.offset(facing)).getBlock() == BlockFruitTreeTrunkTFCE.get(tree))
            {
