...
public class BlockFruitTreeTrunkTFCE extends Block
{
    ...
    private static final Map<IFruitTree, BlockFruitTreeTrunkTFCE> MAP = new HashMap<>();
    ...
    public static BlockFruitTreeTrunkTFCE get(IFruitTree tree)
    {
        return MAP.get(tree);
    }
    ...
    public BlockFruitTreeTrunkTFCE(IFruitTree tree)
    {
    ...
    public IBlockState getActualState(@Nonnull IBlockState state, IBlockAccess worldIn, BlockPos pos)
    {
        ...
        {
            if (worldIn.getBlockState(pos.offset(face)).getBlock() == BlockFruitTreeBranchTFCE.get(tree))
            {
                    ...
                    if (worldIn.getBlockState(pos.up()).getBlock() != this) //If the above block is a trunk, this one don't need to do anything
                    {
                        if (this.getTrunkHeight(worldIn, pos) < 4)
                        {
                            ...
                            if (missingLeaf != null)
                            {
                                ...
                                {
                                    worldIn.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCE.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCE.HARVESTABLE, false));
                                }
                            }
                            else
                            {
                        ...
                        {
                            //Starting with top
                            if (worldIn.getBlockState(pos.up()).getBlock() != BlockFruitTreeBranchTFCE.get(tree))
                            {
                                BlockPos missingLeaf = getMissingLeaf(worldIn, pos);
                                if (missingLeaf != null)
                                {
                                    ...
                                    if (worldIn.getBlockState(missingLeaf).getMaterial().isReplaceable())
                                    {
                                        worldIn.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCE.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCE.HARVESTABLE, true));
                                    }
                                    return; //Done what we needed to do on this stage
                                }
                                else
                                {
                                    worldIn.setBlockState(pos.up(), BlockFruitTreeBranchTFCE.get(tree).getDefaultState());
                            ...
                            for (EnumFacing branchFacing : shuffledList)
                            {
                                ...
                                if (worldIn.getBlockState(branchPos).getBlock() != BlockFruitTreeBranchTFCE.get(tree))
                                {
                                    if (worldIn.getBlockState(branchPos).getMaterial().isReplaceable())
                                    {
                                        worldIn.setBlockState(branchPos, BlockFruitTreeBranchTFCE.get(tree).getDefaultState());
                                    }
                                    return; //Done what we needed to do on this stage
                                }
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos)
    {
        ...
        if (!(worldIn.getBlockState(pos.down()).getBlock() instanceof BlockFruitTreeTrunkTFCE) && !BlocksTFC.isGrowableSoil(worldIn.getBlockState(pos.down())))
        {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        if (!worldIn.isRemote)
        {
            ...
            Block branch = BlockFruitTreeBranchTFCE.get(tree);
    ...
    {
        return new ItemStack(BlockFruitTreeSaplingTFCE.get(tree));
    }
    ...
    private BlockPos getMissingLeaf(World world, BlockPos branchPos, EnumFacing branchFacing)
    {
        ...
        if (world.getBlockState(branchPos.offset(branchFacing)).getBlock() != BlockFruitTreeLeavesTFCE.get(tree))
        {
        ...
        {
            if (world.getBlockState(pos).getBlock() != BlockFruitTreeLeavesTFCE.get(tree))
            {
                return pos;
            }
        }
    ...
    private BlockPos getMissingLeaf(World world, BlockPos pos)
    {
        ...
        //Above first
        if (world.getBlockState(pos.offset(EnumFacing.UP)).getBlock() != BlockFruitTreeLeavesTFCE.get(tree))
        {
        ...
        {
            if (world.getBlockState(pos.offset(facing)).getBlock() != BlockFruitTreeLeavesTFCE.get(tree))
            {
    ...
    private void levelUpLeaves(World world, BlockPos oldCenter, boolean hasvestable)
    {
        ...
        {
            if (world.getBlockState(oldCenter.offset(facing)).getBlock() == BlockFruitTreeLeavesTFCE.get(tree))
            {
        ...
        do
        {
            ...
            {
                world.setBlockState(missingLeaf, BlockFruitTreeLeavesTFCE.get(tree).getDefaultState().withProperty(BlockFruitTreeLeavesTFCE.HARVESTABLE, hasvestable));
            }
            else
            {
