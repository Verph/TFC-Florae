package tfcelementia.objects.items.ceramics;
 ...
 */
public class ItemMoldTFCE extends ItemPottery
{
    private static final EnumMap<ItemMetalTFCE.ItemType, ItemMoldTFCE> MAP = new EnumMap<>(ItemMetalTFCE.ItemType.class);

    public static ItemMoldTFCE get(ItemMetalTFCE.ItemType category)
    {
    ...
    public ItemMoldTFCE(ItemMetalTFCE.ItemType type)
    {
        this.type = type;
    ...
    public String getItemStackDisplayName(@Nonnull ItemStack stack)
    {
        ...
        if (capFluidHandler instanceof IMoldHandler)
        {
            ...
            if (metal != null)
            {
                ...
                return (new TextComponentTranslation("item.tfcelementia.ceramics.mold." + type.name().toLowerCase() + ".filled", metalName)).getFormattedText();
            }
        }
