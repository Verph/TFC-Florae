...
public final class ChunkDataTFCE
{
    ...
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS).getValue(rockLayer1[z << 4 | x]);
    }

    public RockTFCE getRockLayer2(int x, int z)
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS).getValue(rockLayer2[z << 4 | x]);
    }

    public RockTFCE getRockLayer3(int x, int z)
    {
        return ((ForgeRegistry<RockTFCE>) TFCERegistries.ROCKS).getValue(rockLayer3[z << 4 | x]);
    }
