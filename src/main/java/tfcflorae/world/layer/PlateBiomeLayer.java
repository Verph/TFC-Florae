...
public enum PlateBiomeLayer implements CenterTransformLayer
{
    ...
    private static final int[] SUBDUCTION_BIOMES = {VOLCANIC_OCEANIC_MOUNTAINS, VOLCANIC_OCEANIC_MOUNTAINS, VOLCANIC_MOUNTAINS, VOLCANIC_MOUNTAINS, MOUNTAINS, PLATEAU, ALPINE_MOUNTAINS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, CALDERAS, CALDERAS, THERMAL_CANYONS, THERMAL_CANYONS, MISTY_PEAKS};
    private static final int[] OROGENY_BIOMES = {MOUNTAINS, MOUNTAINS, MOUNTAINS, OLD_MOUNTAINS, PLATEAU, ALPINE_MOUNTAINS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, CALDERAS, CALDERAS, THERMAL_CANYONS, THERMAL_CANYONS, MISTY_PEAKS, VINICUNCA_MOUNTAINS};
