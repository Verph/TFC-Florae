...
public enum PlateBiomeLayer implements CenterTransformLayer
{
    ...
    private static final int[] OCEANIC_BIOMES = {DEEP_OCEAN, DEEP_OCEAN, PELAGIC_ZONE};
    private static final int[] OCEAN_CONTINENT_CONVERGING = {DEEP_OCEAN_TRENCH, DEEP_OCEAN_TRENCH, PELAGIC_ZONE, SEAMOUNTS, GUYOTS};
    private static final int[] SUBDUCTION_BIOMES = {VOLCANIC_OCEANIC_MOUNTAINS, VOLCANIC_OCEANIC_MOUNTAINS, VOLCANIC_MOUNTAINS, VOLCANIC_MOUNTAINS, MOUNTAINS, PLATEAU, ALPINE_MOUNTAINS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, THERMAL_CANYONS, THERMAL_CANYONS, MISTY_PEAKS};
    private static final int[] OROGENY_BIOMES = {MOUNTAINS, MOUNTAINS, MOUNTAINS, OLD_MOUNTAINS, PLATEAU, ALPINE_MOUNTAINS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, THERMAL_CANYONS, THERMAL_CANYONS, MISTY_PEAKS, VINICUNCA_MOUNTAINS};
    private static final int[] RIFT_BIOMES = {CANYONS, CANYONS, CANYONS, CANYONS, ROLLING_HILLS, OLD_MOUNTAINS, PUY_MOUNTAINS, BRYCE_CANYONS, MESA_HILLS, ROLLING_HIGHLANDS, THERMAL_CANYONS, THERMAL_CANYONS};
