...
public enum PlateBiomeLayer implements CenterTransformLayer
{
    ...
    private static final int[] CONTINENT_MID_BIOMES = {PLAINS, HILLS, ROLLING_HILLS, INVERTED_BADLANDS, BADLANDS, PLATEAU, LOW_CANYONS, LOWLANDS, GRASSLANDS, WETLANDS, MARSHES, SWAMPS, PUY_MOUNTAINS, MESA_HILLS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, MESA_PLATEAU, STEPPES, SHRUBLANDS, SHRUBLANDS, MOORLANDS};
    private static final int[] CONTINENT_HIGH_BIOMES = {HILLS, ROLLING_HILLS, ROLLING_HILLS, INVERTED_BADLANDS, BADLANDS, PLATEAU, PLATEAU, OLD_MOUNTAINS, OLD_MOUNTAINS, PUY_MOUNTAINS, BRYCE_CANYONS, MESA_HILLS, ALPINE_MOUNTAINS, ALPINE_HIGHLANDS, ROLLING_HIGHLANDS, CALDERAS, THERMAL_CANYONS, SHRUBLANDS, MOORLANDS};
