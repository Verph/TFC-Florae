...
public record RockConfig(Map<Block, List<BlockState>> states) implements FeatureConfiguration
{
    public static final Codec<RockConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
