...
public class LargeDripstoneConfig implements FeatureConfiguration
{
    public static final Codec<LargeDripstoneConfig> CODEC = RecordCodecBuilder.create((p_160966_) -> {
        return p_160966_.group(
            ...
            Codec.intRange(1, 512).fieldOf("floor_to_ceiling_search_range").orElse(30).forGetter((p_160984_) -> {
        ...
        })).apply(p_160966_, LargeDripstoneConfig::new);
    });
    ...
    public LargeDripstoneConfig(Boolean hasSurface, BlockStateProvider state, BlockStateProvider surfaceState, int p_160956_, IntProvider p_160957_, FloatProvider p_160958_, float p_160959_, FloatProvider p_160960_, FloatProvider p_160961_, FloatProvider p_160962_, int p_160963_, float p_160964_)
    {
