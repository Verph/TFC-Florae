...
public class FuelManager
{
    ...
    {
        // Eucalyptus
        FUELS.add(new Fuel(IIngredient.of("logWoodEucalyptus"), 1000, 705f));
        FUELS.add(new Fuel(IIngredient.of(BlockLogTFCF.get(TFCRegistries.TREES.getValue(TreesTFCF.EUCALYPTUS))), 1000, 705f));

        // Coal
        FUELS.add(new Fuel(IIngredient.of("gemAnthracite"), 2650, 1550f, true, true));
        FUELS.add(new Fuel(IIngredient.of("gemBituminousCoal"), 2200, 1415f, true, false));

        // Wood
        FUELS.add(new Fuel(IIngredient.of("driftwood"), 600, 900));
        FUELS.add(new Fuel(IIngredient.of("twig"), 400, 600));
