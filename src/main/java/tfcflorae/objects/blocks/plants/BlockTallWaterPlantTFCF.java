...
public class BlockTallWaterPlantTFCF extends BlockWaterPlantTFCF implements IGrowable, ITallPlant
{
    ...
    private static final Map<PlantTFCF, BlockTallWaterPlantTFCF> MAP = new HashMap<>();

    public static BlockTallWaterPlantTFCF get(PlantTFCF plant)
    {
        return BlockTallWaterPlantTFCF.MAP.get(plant);
    }

    public BlockTallWaterPlantTFCF(PlantTFCF plant)
    {
        super(plant);
