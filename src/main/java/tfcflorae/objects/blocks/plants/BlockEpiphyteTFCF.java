...
public class BlockEpiphyteTFCF extends BlockPlantTFCF
{
    ...
    private static final Map<PlantTFCF, BlockEpiphyteTFCF> MAP = new HashMap<>();

    public static BlockEpiphyteTFCF get(PlantTFCF plantTFCF)
    {
        return MAP.get(plantTFCF);
    }

    public BlockEpiphyteTFCF(PlantTFCF plantTFCF)
    {
        super(plantTFCF);
