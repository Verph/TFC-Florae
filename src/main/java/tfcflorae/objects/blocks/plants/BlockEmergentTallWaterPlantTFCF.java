...
public class BlockEmergentTallWaterPlantTFCF extends BlockTallWaterPlantTFCF implements ITallPlant
{
    private static final Map<PlantTFCF, BlockEmergentTallWaterPlantTFCF> MAP = new HashMap<>();

    public static BlockEmergentTallWaterPlantTFCF get(PlantTFCF plant)
    {
        return BlockEmergentTallWaterPlantTFCF.MAP.get(plant);
    }

    public BlockEmergentTallWaterPlantTFCF(PlantTFCF plant)
    {
        super(plant);
