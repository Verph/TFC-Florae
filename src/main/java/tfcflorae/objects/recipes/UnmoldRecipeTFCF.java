...
public class UnmoldRecipeTFCF extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    ...
    private UnmoldRecipeTFCF(@Nullable ResourceLocation group, NonNullList<Ingredient> input, @Nonnull Metal.ItemType type, float chance)
    {
        this.group = group;
        this.input = input;
        this.type = type;
    ...
    public static class Factory implements IRecipeFactory
    {
        ...
        public IRecipe parse(final JsonContext context, final JsonObject json)
        {
            ...
            return new UnmoldRecipeTFCF(group.isEmpty() ? new ResourceLocation(result) : new ResourceLocation(group), ingredients, type, chance);
        }
    }
}