...
public final class TreesTFCF
{
    ...
    */
    ...
    /*
    public static final ITreeGenerator GEN_ELDER = new TreeGenVariants(true, 15);
    public static final ITreeGenerator GEN_PERSIMMON = new TreeGenVariants(true, 15);
    */
    ...
    */
    ...
    public static void onPreRegisterTrees(TFCRegistryEvent.RegisterPreBlock<Tree> event)
    {
        ...
        //event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "ceylon_cinnamon"), 290f, 550f, 14f, 30f, GEN_CEYLON_CINNAMON).setGrowthTime(8).setDensity(0.25f, 1f).setBurnInfo(710f, 1000).build());
	    ...
	    event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "cypress"), 180f, 350f, 15f, 30f, GEN_CYPRESS).setGrowthTime(8).setConifer().setBurnInfo(783f, 1100).build());
        ...
        // Bamboo
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "arrow_bamboo"), 200f, 420f, 13f, 35f, GEN_ARROW_BAMBOO).setDecayDist(6).setGrowthTime(4).setDensity(0.2f, 2f).setBurnInfo(420f, 1000).build());
    ...
    public static final Tree CASSIA_CINNAMON_TREE = new Tree(new ResourceLocation(TerraFirmaCraft.MOD_ID, "cassia_cinnamon"), GEN_CASSIA_CINNAMON, 28, 35, 280, 400, 0, 0, 0, 4, 15, 4, false, null, false, 15, 0, 0);
    public static final Tree CEYLON_CINNAMON_TREE = new Tree(new ResourceLocation(TerraFirmaCraft.MOD_ID, "ceylon_cinnamon"), GEN_CEYLON_CINNAMON, 28, 35, 280, 400, 0, 0, 0, 4, 15, 4, false, null, false, 15, 0, 0);
}
