...
public final class TreesTFCF
{
    ...
    public static final Tree ASPEN_TREE = new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "aspen"), 10f, 80f, -10f, 16f, GEN_MEDIUM).setRadius(1).setGrowthTime(8).setBurnInfo(611f, 1000).build();
    ...
    public static final Tree BAOBAB_TREE = new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "baobab"), 10f, 150f, 23f, 40f, GEN_BAOBAB).setDecayDist(6).setGrowthTime(20).setDensity(0.1f, 0.3f).setBurnInfo(478f, 1000).build();
    ...
    public static final Tree MAHOGANY_TREE = new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "mahogany"), 220f, 500f, 23f, 42f, GEN_MAHOGANY).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(773f, 1000).build();
    ...
    public static final Tree LARCH_TREE = new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "larch"), 60f, 400f, -12f, 15f, GEN_LARCH).setGrowthTime(8).setConifer().setDensity(0.9f, 1.5f).setBurnInfo(632f, 1250).build();
    ...
    {
    	// Other Trees
    	event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "african_padauk"), 225f, 500f, 27f, 50f, GEN_AFRICAN_PADAUK).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(745f, 1500).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "angelim"), 270f, 500f, 28f, 50f, GEN_ANGELIM).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(773f, 1200).build());
        ...
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "cocobolo"), 205f, 500f, 25f, 50f, GEN_COCOBOLO).setGrowthTime(8).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(773f, 1000).build());
	    event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "ebony"), 180f, 320f, 19f, 38f, GEN_EBONY).setGrowthTime(8).setBurnInfo(795f, 1000).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "fever"), 70f, 220f, 19f, 50f, GEN_FEVER).setGrowthTime(10).setDensity(0.25f, 1f).setBurnInfo(590f, 1000).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "fruitwood"), 180f, 550f, 11f, 30f, GEN_FRUITWOOD).setDominance(0).setGrowthTime(9).setDensity(0f, 0f).setBurnInfo(720f, 1000).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "greenheart"), 260f, 500f, 28f, 50f, GEN_GREENHEART).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(793f, 1700).build());
        ...
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "iroko"), 250f, 500f, 26f, 50f, GEN_IROKO).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(785f, 1200).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "ironwood"), 30f, 210f, 11f, 36f, GEN_IRONWOOD).setDecayDist(6).setGrowthTime(11).setDensity(0.1f, 0.6f).setBurnInfo(694f, 1170).build());
	    event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "kauri"), 310f, 500f, 29f, 50f, GEN_KAURI).setGrowthTime(10).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(730f, 1250).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "limba"), 290f, 550f, 14f, 37f, GEN_LIMBA).setGrowthTime(9).setDensity(0.25f, 1f).setBurnInfo(710f, 1000).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "logwood"), 180f, 430f, 12f, 35f, GEN_LOGWOOD).setGrowthTime(8).setDensity(0.25f, 1f).setBurnInfo(695f, 1000).build());
        ...
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "purpleheart"), 260f, 500f, 27f, 50f, GEN_PURPLEHEART).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(793f, 1700).build());
        ...
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "wenge"), 205f, 500f, 25f, 50f, GEN_WENGE).setGrowthTime(8).setDensity(0.9f, 1.5f).setBurnInfo(773f, 1250).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "yellow_meranti"), 210f, 500f, 26f, 50f, GEN_YELLOW_MERANTI).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(837f, 1200).build());
        event.getRegistry().registerAll(new Tree.Builder(new ResourceLocation(TerraFirmaCraft.MOD_ID, "zebrawood"), 230f, 500f, 28f, 50f, GEN_ZEBRAWOOD).setDecayDist(6).setGrowthTime(18).setBushes().setDensity(0.9f, 1.5f).setBurnInfo(822f, 1570).build());
