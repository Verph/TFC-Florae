...
public class UnmoldMalletRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe
{
    ...
    private UnmoldMalletRecipe(@Nullable ResourceLocation group, NonNullList<Ingredient> input, @Nonnull String type, float chance)
    {
        this.group = group;
        this.input = input;
        this.type = type;
    ...
    public static class Factory implements IRecipeFactory
    {
        ...
        public IRecipe parse(JsonContext context, JsonObject json)
        {
            ...
            return new UnmoldMalletRecipe(group.isEmpty() ? new ResourceLocation(result) : new ResourceLocation(group), ingredients, type, chance);
        }
    }
}