...
public class CastingCategoryFLCompat extends BaseRecipeCategory<CastingRecipeWrapperKaoliniteFL>
{
    ...
    public CastingCategoryFLCompat(IGuiHelper helper, String Uid)
    {
