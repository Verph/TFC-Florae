...
public class TFCFKnappingRecipeCategory<T extends TFCFKnappingRecipe> extends BaseRecipeCategory<T>
{
    @Nullable
    private final IDrawable high, low;

    public TFCFKnappingRecipeCategory(RecipeType<T> type, IGuiHelper helper, ItemStack icon, @Nullable ResourceLocation high, @Nullable ResourceLocation low)
    {
