...
public final class TFCBiomesMixin implements TFCBiomesMixinInterface
{
    ...
    @Unique @Final
    private static final BiomeExtension MANGROVES = register("mangroves", builder().heightmap(seed -> BiomeNoise.hills(seed, -3, -1)).surface(MangroveSurfaceBuilder.create(ShoreSurfaceBuilder.INSTANCE)).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-8).group(BiomeExtension.Group.OCEAN).salty().spawnable());
    @Unique @Final
    ...
    // High biomes
    @Shadow @Mutable @Final
    public static final BiomeExtension MOUNTAINS = register("mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 70)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // High, picturesque mountains. Pointed peaks, low valleys well above sea level.
    @Shadow @Mutable @Final
    public static final BiomeExtension OLD_MOUNTAINS = register("old_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 16, 40)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // Rounded top mountains, very large hills.
    @Shadow @Mutable @Final
    public static final BiomeExtension OCEANIC_MOUNTAINS = register("oceanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, -16, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).aquiferHeightOffset(-8).salty().spawnable()); // Mountains with high areas, and low, below sea level valleys. Water is salt water here.
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_MOUNTAINS = register("volcanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).volcanoes(4, 25, 50, 40)); // Volcanic mountains - slightly smaller, but with plentiful tall volcanoes
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_OCEANIC_MOUNTAINS = register("volcanic_oceanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, -24, 50)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).aquiferHeightOffset(-8).salty().volcanoes(2, -12, 50, 20)); // Volcanic oceanic islands. Slightly smaller and lower but with very plentiful volcanoes
