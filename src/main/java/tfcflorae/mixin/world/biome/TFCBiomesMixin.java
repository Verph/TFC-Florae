...
public final class TFCBiomesMixin implements TFCBiomesMixinInterface
{
    ...
    @Shadow @Mutable @Final
    public static final BiomeExtension LOWLANDS = register("lowlands", builder().heightmap(BiomeNoise::lowlands).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(LowlandsSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-8).spawnable()); // Flat, swamp-like, lots of shallow pools below sea level.
    @Shadow @Mutable @Final
    public static final BiomeExtension LOW_CANYONS = register("low_canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -8, 21)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-16).spawnable()); // Sharp, small hills, with lots of water / snaking winding rivers.

    @Unique @Final
    private static final BiomeExtension GRASSLANDS = register("grasslands", builder().heightmap(seed -> BiomeNoise.hills(seed, 0, 2)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(GrassSurfaceBuilder.create(ForestSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE))))).spawnable()); // Incredibly flat, slightly above sea level.
    @Unique @Final
    private static final BiomeExtension WETLANDS = register("wetlands", builder().heightmap(seed -> BiomeNoise.canyons(seed, -4, 2)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(LowlandsSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-8).spawnable()); // Flat, swamp-like, lots of shallow pools below sea level.
    @Unique @Final
    private static final BiomeExtension MARSHES = register("marshes", builder().heightmap(seed -> BiomeNoise.hills(seed, -3, -2)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(LowlandsSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-8).spawnable()); // Flat, swamp-like, lots of shallow pools below sea level.
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension MANGROVES = register("mangroves", builder().heightmap(seed -> BiomeNoise.hills(seed, -3, -1)).surface(MangroveSurfaceBuilder.create(DuneShoreSurfaceBuilder.create(ShoreSurfaceBuilder.INSTANCE))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-8).group(BiomeExtension.Group.OCEAN).salty().spawnable());
    @Unique @Final
    private static final BiomeExtension PUY_MOUNTAINS = register("puy_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 8, 30)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).aquiferHeightOffset(-32).spawnable());
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension ROLLING_HIGHLANDS = register("rolling_highlands", builder().heightmap(seed -> TFCFBiomeNoise.badlands(seed, -10, 64)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable());
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension GRAVEL_SHORE = register("gravel_shore", builder().heightmap(BiomeNoise::shore).surface(GravelShoreSurfaceBuilder.INSTANCE).aquiferHeightOffset(-16).carving(TFCFBiomeNoise::undergroundCavesUpper).group(BiomeExtension.Group.OCEAN).salty());
    @Unique @Final
    private static final BiomeExtension THERMAL_CANYONS = register("thermal_canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -10, 18)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable().volcanoes(2, -12, 20, 10).aquiferHeightOffset(-16));
    @Unique @Final
    private static final BiomeExtension MESA_PLATEAU = register("mesa_plateau", builder().heightmap(seed -> BiomeNoise.canyons(seed, 60, 66)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))))).spawnable());
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension STEPPES = register("steppes", builder().heightmap(seed -> BiomeNoise.hills(seed, 2, 5)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(GrassSurfaceBuilder.create(ForestSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE))))).spawnable());
    @Unique @Final
    ...
    private static final BiomeExtension MISTY_PEAKS = register("misty_peaks", builder().heightmap(seed -> TFCFBiomeNoise.mistyPeaks(seed, -5, 35)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable());
    @Unique @Final
    private static final BiomeExtension COASTAL_CLIFFS = register("coastal_cliffs", builder().heightmap(seed -> TFCFBiomeNoise.coastalCliffs(seed, 0, 10)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable());
    @Unique @Final // Beach dunes
    private static final BiomeExtension SHORE_DUNES = register("shore_dunes", builder().heightmap(seed -> TFCFBiomeNoise.dunes(seed, 2, 14)).surface(SubSoilSurfaceBuilder.create(DuneShoreSurfaceBuilder.create(ShoreSurfaceBuilder.INSTANCE))).aquiferHeightOffset(-16).group(BiomeExtension.Group.OCEAN).salty().spawnable()); // Standard shore / beach. Material will vary based on location
    @Unique @Final // Zhangjiajie National Forest Park biome
    private static final BiomeExtension VINICUNCA_MOUNTAINS = register("vinicunca_mountains", builder().heightmap(seed -> TFCFBiomeNoise.rainbowMountains(seed, 30, 50)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RainbowMountainsSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(RockyDirtSurfaceBuilder.create((MountainSurfaceBuilder.INSTANCE)))))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable());

    // Mid biomes
    @Shadow @Mutable @Final
    public static final BiomeExtension ROLLING_HILLS = register("rolling_hills", builder().heightmap(seed -> BiomeNoise.hills(seed, -5, 28)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).spawnable()); // Higher hills, above sea level. Some larger / steeper hills.
    @Shadow @Mutable @Final
    public static final BiomeExtension BADLANDS = register("badlands", builder().heightmap(BiomeNoise::badlands).surface(TopBadlandsSurfaceBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(BadlandsSurfaceBuilder.NORMAL))), false)).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // Very high flat area with steep relief carving, similar to vanilla mesas.
    @Shadow @Mutable @Final
    public static final BiomeExtension INVERTED_BADLANDS = register("inverted_badlands", builder().heightmap(BiomeNoise::bryceCanyon).surface(TopBadlandsSurfaceBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(BadlandsSurfaceBuilder.INVERTED)), true)).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // Inverted badlands: hills with additive ridges, similar to vanilla bryce canyon mesas.
    @Shadow @Mutable @Final
    ...
    @Shadow @Mutable @Final
    public static final BiomeExtension CANYONS = register("canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -2, 40)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).volcanoes(6, 14, 30, 28).spawnable()); // Medium height with snake like ridges, minor volcanic activity

    // High biomes
    @Shadow @Mutable @Final
    public static final BiomeExtension MOUNTAINS = register("mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 70)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // High, picturesque mountains. Pointed peaks, low valleys well above sea level.
    @Shadow @Mutable @Final
    public static final BiomeExtension OLD_MOUNTAINS = register("old_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 16, 40)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable()); // Rounded top mountains, very large hills.
    @Shadow @Mutable @Final
    public static final BiomeExtension OCEANIC_MOUNTAINS = register("oceanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, -16, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).aquiferHeightOffset(-8).salty().spawnable()); // Mountains with high areas, and low, below sea level valleys. Water is salt water here.
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_MOUNTAINS = register("volcanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).volcanoes(4, 25, 50, 40)); // Volcanic mountains - slightly smaller, but with plentiful tall volcanoes
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_OCEANIC_MOUNTAINS = register("volcanic_oceanic_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, -24, 50)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCavesUpper).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).aquiferHeightOffset(-8).salty().volcanoes(2, -12, 50, 20)); // Volcanic oceanic islands. Slightly smaller and lower but with very plentiful volcanoes
    ...
    // Water
    @Shadow @Mutable @Final
    public static final BiomeExtension LAKE = register("lake", builder().heightmap(BiomeNoise::lake).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GravelSurfaceBuilder.create(GrassSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).aquiferHeightOffset(-16).group(BiomeExtension.Group.LAKE));
    @Shadow @Mutable @Final
    ...
    @Shadow @Mutable @Final
    public static final BiomeExtension MOUNTAIN_RIVER = register("mountain_river", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 70)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(BiomeNoise::undergroundRivers).group(BiomeExtension.Group.RIVER));
    @Shadow @Mutable @Final
    ...
    @Shadow @Mutable @Final
    public static final BiomeExtension OCEANIC_MOUNTAIN_RIVER = register("oceanic_mountain_river", builder().heightmap(seed -> BiomeNoise.mountains(seed, -16, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(BiomeNoise::undergroundRivers).salty().group(BiomeExtension.Group.RIVER));
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_MOUNTAIN_RIVER = register("volcanic_mountain_river", builder().heightmap(seed -> BiomeNoise.mountains(seed, 10, 60)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).volcanoes(4, 25, 50, 40).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(BiomeNoise::undergroundRivers).group(BiomeExtension.Group.RIVER));
    @Shadow @Mutable @Final
    public static final BiomeExtension VOLCANIC_OCEANIC_MOUNTAIN_RIVER = register("volcanic_oceanic_mountain_river", builder().heightmap(seed -> BiomeNoise.mountains(seed, -24, 50)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesMiddle).carving(TFCFBiomeNoise::undergroundCavesDeep).carving(TFCFBiomeNoise::undergroundCavesDeep).volcanoes(2, -12, 50, 20).carving(BiomeNoise::undergroundRivers).salty().group(BiomeExtension.Group.RIVER));
