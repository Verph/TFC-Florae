...
public final class TFCBiomesMixin implements TFCBiomesMixinInterface
{
    ...
    @Unique @Final
    private static final BiomeExtension MANGROVES = register("mangroves", builder().heightmap(seed -> BiomeNoise.hills(seed, -3, -1)).surface(MangroveSurfaceBuilder.create(ShoreSurfaceBuilder.INSTANCE)).aquiferHeightOffset(-10).group(BiomeExtension.Group.OCEAN).salty().spawnable());
    @Unique @Final
    private static final BiomeExtension PUY_MOUNTAINS = register("puy_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 8, 30)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCaves).spawnable());
    @Unique @Final
    private static final BiomeExtension BRYCE_CANYONS = register("bryce_canyons", builder().heightmap(TFCFBiomeNoise::grandCanyon).surface(SubSoilSurfaceBuilder.create(BadlandsSurfaceBuilder.INVERTED)).spawnable());
    @Unique @Final
    private static final BiomeExtension MESA_HILLS = register("mesa_hills", builder().heightmap(seed -> BiomeNoise.canyons(seed, -10, 64)).surface(SubSoilSurfaceBuilder.create(BadlandsSurfaceBuilder.INVERTED)).spawnable());
    @Unique @Final
    private static final BiomeExtension CANYON_RIVER = register("canyon_river", builder().heightmap(seed -> BiomeNoise.canyons(seed, -8, 64)).surface(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE))).aquiferHeight(h -> TFCChunkGenerator.SEA_LEVEL_Y - 16).carving(BiomeNoise::undergroundRivers).group(BiomeExtension.Group.RIVER));
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension ALPINE_MOUNTAINS = register("alpine_mountains", builder().heightmap(seed -> BiomeNoise.mountains(seed, 72, 100)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCavesDeep).volcanoes(6, 14, 30, 28).spawnable());
    @Unique @Final
    private static final BiomeExtension ALPINE_HIGHLANDS = register("alpine_highlands", builder().heightmap(seed -> BiomeNoise.canyons(seed, 32, 100)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE))))).carving(TFCFBiomeNoise::undergroundCavesDeep).spawnable());
    @Unique @Final
    private static final BiomeExtension ROLLING_HIGHLANDS = register("rolling_highlands", builder().heightmap(seed -> TFCFBiomeNoise.badlands(seed, -10, 64)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE))))).spawnable());
    @Unique @Final
    private static final BiomeExtension CALDERAS = register("calderas", builder().heightmap(seed -> TFCFBiomeNoise.badlands(seed, 21, 32)).surface(SubSoilSurfaceBuilder.create(LowMountainSurfaceBuilder.INSTANCE)).carving(TFCFBiomeNoise::undergroundCaves).group(BiomeExtension.Group.LAKE));
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension THERMAL_CANYONS = register("thermal_canyons", builder().heightmap(seed -> BiomeNoise.canyons(seed, -10, 18)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE))))).spawnable());
    @Unique @Final
    private static final BiomeExtension MESA_PLATEAU = register("mesa_plateau", builder().heightmap(seed -> BiomeNoise.canyons(seed, 60, 66)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(NormalSurfaceBuilder.INSTANCE))))).spawnable());
    @Unique @Final
    private static final BiomeExtension PEAT_BOG = register("peat_bog", builder().heightmap(seed -> BiomeNoise.canyons(seed, -4, 1)).surface(RoadNetworkBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(LowlandsSurfaceBuilder.INSTANCE))))).aquiferHeightOffset(-8).spawnable()); // Flat, swamp-like, lots of shallow pools below sea level.
