...
public final class TFCBiomesMixin implements TFCBiomesMixinInterface
{
    ...
    @Unique @Final
    private static final BiomeExtension SEAMOUNTS = register("seamounts", builder().heightmap(seed -> TFCFBiomeNoise.seamounts(seed, -110, -90)).surface(OceanSurfaceBuilder.INSTANCE).group(BiomeExtension.Group.OCEAN).salty().volcanoes(3, -12, 50, 0));
    @Unique @Final
    private static final BiomeExtension GUYOTS = register("guyots", builder().heightmap(seed -> TFCFBiomeNoise.seamounts(seed, -200, -90)).surface(OceanSurfaceBuilder.INSTANCE).group(BiomeExtension.Group.OCEAN).salty().volcanoes(1, -12, 50, 0));
    @Unique @Final
    private static final BiomeExtension BARRIER_REEF = register("barrier_reef", builder().heightmap(seed -> BiomeNoise.mountains(seed, 0, 30)).surface(DuneShoreSurfaceBuilder.create(SubSoilSurfaceBuilder.create(RockyDirtSurfaceBuilder.create(ForestSurfaceBuilder.create(GrassSurfaceBuilder.create(MountainSurfaceBuilder.INSTANCE)))))).carving(TFCFBiomeNoise::undergroundCavesMiddle1).carving(TFCFBiomeNoise::undergroundCavesDeep1).carving(TFCFBiomeNoise::undergroundCavesDeep2).group(BiomeExtension.Group.OCEAN).volcanoes(1, 25, 50, 5).salty());
    @Unique @Final
    ...
    @Unique @Final
    private static final BiomeExtension ATOLL = register("atoll", builder().heightmap(seed -> TFCFBiomeNoise.dunes(seed, 1, 6)).surface(DuneShoreSurfaceBuilder.create(ShoreSurfaceBuilder.INSTANCE)).carving(TFCFBiomeNoise::undergroundCaves).carving(TFCFBiomeNoise::undergroundCavesMiddle1).carving(TFCFBiomeNoise::undergroundCavesDeep1).salty());
