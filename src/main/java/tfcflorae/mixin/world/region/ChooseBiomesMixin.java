...
public class ChooseBiomesMixin
{
    ...
    @Shadow @Mutable @Final private static final int[] MID_DEPTH_OCEAN_BIOMES = {PELAGIC_ZONE, SEAMOUNTS, GUYOTS, DEEP_OCEAN, DEEP_OCEAN, OCEAN, OCEAN, OCEAN, OCEAN, OCEAN_REEF, OCEAN_REEF, OCEAN_REEF, OCEAN_REEF, OCEAN_REEF, OCEAN_REEF};
}
