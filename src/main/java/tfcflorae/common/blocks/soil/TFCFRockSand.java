...
public enum TFCFRockSand
{
    ...
    SANDIEST_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCBlocks.SAND.get(sandColor), null, TFCFBlocks.ROCK_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCBlocks.SAND.get(sandColor), null, TFCFBlocks.TFCF_ROCKTYPE_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true)),
    SANDIER_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCFBlocks.ROCKY_SAND_TFC.get(self.transform()).get(sandColor).get(rock), null, null, false),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCFBlocks.ROCKY_SAND_TFCF.get(self.transform()).get(sandColor).get(rock), null, null, false)),
    SANDY_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCFBlocks.ROCKY_SAND_TFC.get(self.transform()).get(sandColor).get(rock), null, null, false),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, MaterialColor.SAND).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(Colors.fromTFC(sandColor)), TFCFBlocks.ROCKY_SAND_TFCF.get(self.transform()).get(sandColor).get(rock), null, null, false));
