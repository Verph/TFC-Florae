...
public enum TFCFRockSand
{
    ...
    ROCKIER((self, sandColor, rock) -> new RockySoilBlock(Block.Properties.of(Material.SAND, sandColor.getMaterialColor()).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCBlocks.ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.ROCKY_SAND_TFC.get(self.transform()).get(sandColor).get(rock), TFCFBlocks.ROCKY_SAND_TFC.get(ROCKY).get(sandColor).get(rock), null, false),
                        (self, sandColor, rock) -> new RockySoilBlock(Block.Properties.of(Material.SAND, sandColor.getMaterialColor()).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.TFCF_ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.ROCKY_SAND_TFCF.get(self.transform()).get(sandColor).get(rock), TFCFBlocks.ROCKY_SAND_TFCF.get(ROCKY).get(sandColor).get(rock), null, false)),
    ...
    SANDIEST_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCBlocks.SAND.get(sandColor.toSandTFC(true)), null, TFCFBlocks.ROCK_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCBlocks.SAND.get(sandColor.toSandTFC(true)), null, TFCFBlocks.TFCF_ROCKTYPE_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true)),
    SANDIER_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCFBlocks.ROCKY_SAND_TFC.get(self.transform()).get(sandColor).get(rock), null, null, false),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCFBlocks.ROCKY_SAND_TFCF.get(self.transform()).get(sandColor).get(rock), null, null, false)),
    SANDY_TILES((self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCFBlocks.ROCKY_SAND_TFC.get(self.transform()).get(sandColor).get(rock), null, null, false),
                        (self, sandColor, rock) -> new TFCFRockySoilBlock(Block.Properties.of(Material.STONE, sandColor.getMaterialColor()).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.SAND_LAYERS.get(sandColor), TFCFBlocks.ROCKY_SAND_TFCF.get(self.transform()).get(sandColor).get(rock), null, null, false));
