...
public class LargeKaoliniteVesselBlockEntity extends InventoryBlockEntity<LargeKaoliniteVesselBlockEntity.VesselInventory>
{
    ...
    {
        super(TFCFBlockEntities.LARGE_KAOLINITE_VESSEL.get(), pos, state, VesselInventory::new, NAME);
    }
    ...
    {
        return LargeKaoliniteVesselContainer.create(this, inv, windowID);
    }
    ...
    public static class VesselInventory extends InventoryItemHandler implements INBTSerializable<CompoundTag>, EmptyInventory
    {
        ...
        {
            super(entity, SLOTS);
            vessel = (LargeKaoliniteVesselBlockEntity) entity;
        }
        ...
        {
            return !vessel.getBlockState().getValue(LargeKaoliniteVesselBlock.SEALED);
        }
    }
}