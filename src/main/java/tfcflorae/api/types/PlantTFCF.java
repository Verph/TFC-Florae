...
public class PlantTFCF extends IForgeRegistryEntry.Impl<PlantTFCF>
{
    ...
    private final PlantTypeTFCF plantType;
    ...
    /*public PlantTFCF(@Nonnull ResourceLocation name, PlantTypeTFCF plantType, int[] stages, boolean isClayMarking, boolean isSwampPlant, float minGrowthTemp, float maxGrowthTemp, float minTemp, float maxTemp, float minRain, float maxRain, int minSun, int maxSun, int maxHeight, double movementMod, String oreDictName)
    {
    ...
    @Nonnull
    public PlantTypeTFCF getPlantType()
    {
        return plantType;
    }
    ...
    public IBlockState getWaterType()
    {
        if 
        (
            plantType == PlantTypeTFCF.WATER_SEA || 
            plantType == PlantTypeTFCF.TALL_WATER_SEA || 
            plantType == PlantTypeTFCF.EMERGENT_TALL_WATER_SEA
        )
        {
            return SALT_WATER;
        }
    ...
    {
        return
        plantType == PlantTypeTFCF.STANDARD;
    }

    public final EnumPlantTypeTFCF getEnumPlantTypeTFC()
    {
        switch (plantType)
        {
            case WATER:
            ...
            case EMERGENT_TALL_WATER:
                return EnumPlantTypeTFCF.FRESH_WATER;
            case WATER_SEA:
            case TALL_WATER_SEA:
            case EMERGENT_TALL_WATER_SEA:
                return EnumPlantTypeTFCF.SALT_WATER;
            default:
                if (isClayMarking) return EnumPlantTypeTFCF.CLAY;
                else return EnumPlantTypeTFCF.NONE;
        }
    }
    ...
    public enum PlantTypeTFCF implements IPlantTypeTFCF
    {
        STANDARD(BlockPlantTFCF::new),
        WATER(BlockWaterPlantTFCF::new),
        WATER_SEA(BlockWaterPlantTFCF::new),
        TALL_WATER(BlockTallWaterPlantTFCF::new),
        TALL_WATER_SEA(BlockTallWaterPlantTFCF::new),
        EMERGENT_TALL_WATER(BlockEmergentTallWaterPlantTFCF::new),
        EMERGENT_TALL_WATER_SEA(BlockEmergentTallWaterPlantTFCF::new);

        private final Function<PlantTFCF, BlockPlantTFCF> supplier;

        PlantTypeTFCF(@Nonnull Function<PlantTFCF, BlockPlantTFCF> supplier)
        {
            this.supplier = supplier;
        }

        @Override
        public BlockPlantTFCF create(PlantTFCF plant)
        {
